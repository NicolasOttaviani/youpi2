<div class="configuration" style={`transform: translateY(-${$transform}px)`}>
    <fieldset>
        ...
        <ConfigurationBody bind:value={config.player} on:help={({detail}) => help(detail)} />
    </fieldset>
    <fieldset>
        <legend>Ball</legend>
            <label>
            ...
            <ConfigurationBody bind:value={config.ball} on:help={({detail}) => help(detail)} />
    </fieldset>
        <fieldset>
        ...
        <ConfigurationBody bind:value={config.border} on:help={({detail}) => help(detail)} staticBody={true} />
    </fieldset>
    <fieldset>
        <legend>Rules</legend>
        <label>
